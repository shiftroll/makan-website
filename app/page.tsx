  ...
  return (
    <main>
      ...
      <section className="relative h-screen flex items-center justify-center text-white">
        ...
        {/* Video with better browser support */}
        <video
          autoPlay
          loop
          muted
        ...
        >
          ...
          <source
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/git-blob/prj_6xdpt5lYgVI0WhikTyIKsySulOzD/z0bKx__d5AHCjgixAMIQp_/public/hero-video.mp4"
            type="video/mp4"
          />
